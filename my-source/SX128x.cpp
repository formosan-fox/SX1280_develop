...
#ifdef SOPHIA_V1
uint8_t SX128x::HalGpioRead(GpioPinFunction_t func)
{
	uint8_t rx;
	switch (func)
	{
...
void SX128x::HalGpioWrite(GpioPinFunction_t func, uint8_t value)
{
	uint8_t rx;
	if(value == 0)
	{
...
void SX128x::HalSpiTransfer(uint8_t *buffer_in, const uint8_t *buffer_out, uint16_t size)
{
